        ...
        while 1:
            ...
            if env.landlord_count == 3 or env.winner >= 0:
                ...
                for _ in range(3):
                    ...
                    if pid in f_memory:
                        ...
                        (_state, _act_ids, _label_mask, _attn_mask, _dyn_vec, _action, _h_vec, _h_pid) = f_memory[pid]
                        rl.store_f(_state, _act_ids, _label_mask, _attn_mask, _dyn_vec, _action, _h_vec, _h_pid,
                                   f_reward, state, act_ids, label_mask, attn_mask, dyn_vec, h_vec, h_pid)
                    pid = (pid + 1) % 3
            ...
            # 斗地主环节
                ...
                # 暂不考虑炸弹使奖惩翻番的效果，以胜利为唯一目标
                    ...
                    # 更新记忆器
                    f_memory[pid] = (state, act_ids, label_mask, attn_mask, dyn_vec, action, h_vec, h_pid)
